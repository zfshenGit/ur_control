...
echo_and_run cd "/home/zfshen/ur5_ws_szf/src/universal_robot-melodic-devel/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/zfshen/ur5_ws_szf/src/universal_robot-melodic-devel/ur_kinematics/setup.py" \
     \
    build --build-base "/home/zfshen/ur5_ws_szf/build/universal_robot-melodic-devel/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
